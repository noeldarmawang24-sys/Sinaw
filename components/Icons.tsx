...
export const SealIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M12 2l-8 4.5v9l8 4.5 8-4.5v-9L12 2zm-1 12.5l-3-1.7v-3.6l3 1.7v3.6zm1-10.8l6 3.4-6 3.4-6-3.4 6-3.4zm1 10.8v-3.6l3-1.7v3.6l-3 1.7z" clipRule="evenodd" />
    </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path d="M3.75 12.375l9-6.75 9 6.75M3.75 12.375V19.5h16.5V12.375M3.75 12.375L12 18.75l8.25-6.375" />
